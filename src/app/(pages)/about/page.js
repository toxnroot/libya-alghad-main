...
export default function About() {
  return (
    <>
      {/* تحسين السيو للموقع */}
      <Head>
        <meta name="description" content="تعرف على شركة ليبيا الغد الرائدة في مجال المقاولات العامة والاستثمار العقاري. نقدم حلول مبتكرة وفعالة للمشاريع الكبيرة والمتنوعة." />
        <meta name="keywords" content="ليبيا الغد, مقاولات, استثمار عقاري, مشاريع ليبيا, خدمات البناء" />
        <meta property="og:title" content="من نحن - شركة ليبيا الغد" />
        <meta property="og:description" content="تعرف على شركة ليبيا الغد الرائدة في مجال المقاولات العامة والاستثمار العقاري." />
        <meta property="og:image" content="https://res.cloudinary.com/do88eynar/image/upload/v1744003847/about_xrumil.webp" />
        <meta property="og:url" content="https://libyaalghad.com/about" />
        <meta name="twitter:title" content="من نحن - شركة ليبيا الغد" />
        <meta name="twitter:description" content="تعرف على شركة ليبيا الغد الرائدة في مجال المقاولات العامة والاستثمار العقاري." />
        <meta name="twitter:image" content="https://res.cloudinary.com/do88eynar/image/upload/v1744003847/about_xrumil.webp" />
